    ...
    <footer className="text-gray-600 body-font">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <Link className="text-gray-500" href={siteMetadata.facebook}>
            <svg
              fill="currentColor"
              strokeLinecap="round"
          ...
          <Link className="ml-3 text-gray-500" href={siteMetadata.twitter}>
            <svg
              fill="currentColor"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <Link className="ml-3 text-gray-500" href={siteMetadata.linkedin}>
            <svg
              fill="currentColor"
              stroke="currentColor"
              strokeLinecap="round"
